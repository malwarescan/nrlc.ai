 ...
 * Prechunking SEO methodology applied to car repairs information engineering
 */

require_once __DIR__ . '/../../lib/schema_builders.php';

// Use canonical path from router metadata (includes locale prefix)
$canonicalPath = $GLOBALS['__page_meta']['canonicalPath'] ?? '/en-us/ai-visibility/auto-repair/';
...
$GLOBALS['__jsonld'] = [
  [
    ...
    'url' => $canonicalUrl,
    'name' => 'AI Visibility for Auto Repair / Specialty Mechanics',
    'description' => 'Technical service that engineers car repairs information for AI retrieval, verification, and citation. Prechunking methodology for Auto Repair / Specialty Mechanics.',
    'isPartOf' => [
      '@type' => 'WebSite',
      '@id' => $domain . '#website',
      'name' => 'NRLC.ai',
    ...
    'breadcrumb' => [
      ...
      'itemListElement' => [
        ...
        ['@type' => 'ListItem', 'position' => 3, 'name' => 'Auto Repair / Specialty Mechanics', 'item' => $canonicalUrl]
      ]
    ]
  ],
  [
    ...
    'description' => 'Engineering service that structures car repairs information so AI systems can retrieve, verify, and cite it accurately. Prechunking methodology for Auto Repair / Specialty Mechanics.',
...
<section class="section">
  <div class="section__content">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">How AI Systems Answer Auto Repair / Specialty Mechanics Questions</h2>
      </div>
      <div class="content-block__body">
        <p>AI systems answer car repairs questions by retrieving structured information that can be verified and cited safely.</p>
        
        <p>Common questions AI systems process include:</p>
        <ul>
          <li>"Am I being overcharged?"</li>
          <li>"How much should this repair cost?"</li>
          <li>"Is this repair necessary?"</li>
          <li>"How do I find a trustworthy mechanic?"</li>
        </ul>

        <p>To answer these questions reliably, AI systems look for:</p>
        <ul>
          <li>Clear cost explanations with diagnostic transparency</li>
          <li>Factual explanations of repair processes and typical costs</li>
          <li>Legitimate credential verification and licensing information</li>
          <li>Structured definitions of services, diagnostics, and limitations</li>
          <li>Consistent terminology and process clarity</li>
        </ul>

        <p>When car repairs information is ambiguous, inconsistent, or unstructured, AI systems either skip it or fill gaps with less accurate sources. This is why information must be engineered for extraction and verification.</p>
      </div>
    </div>
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Our Method: Prechunking Auto Repair / Specialty Mechanics Information</h2>
      </div>
      <div class="content-block__body">
        <p>We pre-chunk car repairs information so it can be safely extracted, verified, and cited by AI systems.</p>
        ...
        <p>Prechunking happens at the publishing stage, not during AI retrieval. We engineer car repairs information so it survives extraction intact.</p>
      </div>
    </div>
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Seeding Retrievable Auto Repair / Specialty Mechanics Knowledge</h2>
      </div>
      <div class="content-block__body">
        <p>We publish authoritative informational resources that define car repairs services, explain processes, clarify scope and limitations, and remove ambiguity.</p>
        ...
        <p>We engineer car repairs-specific informational resources that:</p>
        <ul>
          ...
          <li>Remove ambiguity about what a shop does and does not do</li>
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Reverse-Engineering Real Auto Repair / Specialty Mechanics Questions</h2>
      </div>
      <div class="content-block__body">
        ...
        <ul>
          <li>Real questions people ask about car repairs</li>
        ...
        <ul>
          <li>Primary questions (e.g., "Am I being overcharged?" or "How much should this cost?")</li>
          <li>Follow-up questions (e.g., "Is this repair necessary?" or "How do I find a trustworthy mechanic?")</li>
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">What This Looks Like in Practice (Auto Repair / Specialty Mechanics-Specific)</h2>
      </div>
      <div class="content-block__body">
        <p>Prechunking car repairs information produces concrete, structured content that answers questions clearly and safely.</p>

        <p>Examples of prechunked car repairs content include:</p>
        <ul>
          ...
          <li><strong>Clarified cost and diagnostic transparency:</strong> Costs and diagnostics are defined clearly, with specific explanations and transparency. No ambiguous pricing or diagnostic claims.</li>
          ...
          <li><strong>Consistent terminology:</strong> Automotive terms, service names, and diagnostic descriptions use consistent language across all content. No synonym confusion or ambiguous naming.</li>
        </ul>

        <p>This structured approach ensures Auto Repair / Specialty Mechanics are represented accurately and safely when AI systems retrieve and cite information.</p>
      </div>
    </div>
    ...
    <div class="content-block module">
      ...
      <div class="content-block__body">
        ...
        <ul>
          ...
          <li>Replace automotive licensing, professional judgment, or regulatory compliance</li>
          <li>Manipulate AI systems with hidden text or deceptive practices</li>
          <li>Promise specific rankings or traffic increases</li>
        </ul>

        <p>This service engineers information for retrieval. It does not guarantee retrieval will occur, nor does it replace professional automotive standards or regulatory compliance.</p>
      </div>
    </div>
