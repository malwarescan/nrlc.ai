  ...
  <div class="section__content">
    <div class="content-block module">
      <div class="content-block__header">
        <h1 class="content-block__title">AI Answer Engine Citation Behavior: The GEO-16 Framework</h1>
      </div>
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">The Citation Visibility Problem</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Research Foundation</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">The GEO-16 Scoring System</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Methodology Overview</h2>
      </div>
      <div class="content-block__body">
