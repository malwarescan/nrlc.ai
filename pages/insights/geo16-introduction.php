...
<section class="window container prose">
  <div class="window-title">GEO-16 Framework: Introduction</div>
  <div class="window-content">
    <h1>AI Answer Engine Citation Behavior: The GEO-16 Framework</h1>
    <p class="lead">Empirical analysis reveals why some pages get cited by AI engines while others remain invisible. The GEO-16 framework quantifies the sixteen critical signals that determine citation success in generative search engines.</p>
    
    <h2>The Citation Visibility Problem</h2>
    ...
    <h2>The GEO-16 Scoring System</h2>
