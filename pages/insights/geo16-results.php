  ...
  <div class="section__content">
    <div class="content-block module">
      <div class="content-block__header">
        <h1 class="content-block__title">Research Results: Citation Performance Analysis</h1>
      </div>
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Overall Citation Patterns</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Engine-Specific Performance</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Content Type Analysis</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Pillar Performance Analysis</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Threshold Analysis</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Organizational Context</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Geographic and Language Factors</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Implications for Content Strategy</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Validation and Future Research</h2>
      </div>
      <div class="content-block__body">
