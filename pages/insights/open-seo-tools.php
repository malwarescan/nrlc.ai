...
<section class="section">
  <div class="section__content">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">The Open Source SEO Landscape</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Core Open Source SEO Tools</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Advanced Open Source Tools</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">NRLC.ai Tool Integrations</h2>
      </div>
      <div class="content-block__body">
    ...
    <div class="content-block module">
      <div class="content-block__header">
        <h2 class="content-block__title">Future Tool Development</h2>
      </div>
      <div class="content-block__body">
