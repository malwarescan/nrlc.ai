    ...
    <article itemscope itemtype="https://schema.org/Course">
      <div class="content-block module">
        ...
        <div class="content-block__body">
          ...
          <div class="btn-group text-center" style="margin: 1.5rem 0; gap: 1rem; display: flex; justify-content: center; flex-wrap: wrap;">
            ...
            <a href="/training/" class="btn" style="background: transparent; border: 1px solid #4a90e2; color: #4a90e2;">All Training Programs</a>
          </div>
      ...
      <div class="content-block module">
        ...
        <div class="content-block__body">
          ...
          <div class="box-padding">
            <h3 style="margin-top: 0; color: #000080;">Agent Operation & Supervision</h3>
            <p>Teams learn to:</p>
            <ul>
          ...
          <div class="box-padding">
            <h3 style="margin-top: 0; color: #000080;">AI Search Surfaces & Retrieval Mechanics</h3>
          ...
          <div class="box-padding">
            <h3 style="margin-top: 0; color: #000080;">Content as Machine-Interpretable Information</h3>
      ...
      <div class="content-block module">
        ...
        <div class="content-block__body">
          ...
          <div class="box-padding">
            <h3 style="margin-top: 0; color: #000080;">One-on-One Operator Training</h3>
          ...
          <div class="box-padding">
            <h3 style="margin-top: 0; color: #000080;">Team & Group Sessions</h3>
          ...
          <div class="box-padding">
            <h3 style="margin-top: 0; color: #000080;">Workshops & Documentation</h3>
      ...
      <div class="content-block module">
        ...
        <div class="content-block__body">
          ...
          <div class="box-padding">
            <h3 style="margin-top: 0; color: #000080;">Local Market Context</h3>
      ...
      <div class="content-block module">
        ...
        <div class="content-block__body">
          ...
          <div class="btn-group text-center" style="margin: 1.5rem 0; gap: 1rem; display: flex; justify-content: center; flex-wrap: wrap;">
            <a href="/training/one-on-one/" class="btn btn--primary">View Training Courses</a>
            <button type="button" class="btn" style="background: transparent; border: 1px solid #4a90e2; color: #4a90e2;" onclick="openContactSheet('Training Inquiry for <?= htmlspecialchars($cityTitle) ?>')">Contact About Training</button>
          </div>
          <p style="text-align: center; font-size: 0.9rem; color: #666; margin-top: 0.5rem;">No obligation. Response within 24 hours.</p>
        </div>
      </div>
