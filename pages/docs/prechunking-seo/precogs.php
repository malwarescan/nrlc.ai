...
add_jsonld(webpage_schema([
  ...
  'url' => $canonicalUrl,
  'name' => 'Precog Modeling',
  'description' => 'Precog modeling for prechunking SEO. Intent forecasting, follow-up questions, and trust-question identification.',
