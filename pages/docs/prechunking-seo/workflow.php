...
add_jsonld(webpage_schema([
  ...
  'url' => $canonicalUrl,
  'name' => 'Prechunking Workflow',
  'description' => 'Prechunking SEO workflow. Intent decomposition, crouton inventory, data shaping, and structured publishing.',
  ...
  'breadcrumb' => breadcrumb_schema([
    ...
    ['name' => 'Workflow', 'url' => $canonicalUrl]
  ])
]));
?>
