...
// Homepage ONLY includes: Organization, WebSite (with SearchAction), BreadcrumbList
// FORBIDDEN on homepage: Service, FAQPage, Product, JobPosting, Article, Event, HowTo, Review
