...
<section class="window container prose">
  <div class="title-bar">
    <div class="title-bar-text">AI SEO Case Studies</div>
  </div>
...
<script type="application/ld+json">
{
 ...
 "mainEntity":{
  "@type":"ItemList",
  "itemListElement":[
   {"@type":"ListItem","position":1,"name":"B2B SaaS Case Study"},
   {"@type":"ListItem","position":2,"name":"E-commerce Case Study"},
   {"@type":"ListItem","position":3,"name":"Healthcare Case Study"},
   {"@type":"ListItem","position":4,"name":"Fintech Case Study"},
   {"@type":"ListItem","position":5,"name":"Education Case Study"},
   {"@type":"ListItem","position":6,"name":"Real Estate Case Study"}
  ]
 }
}
</script>
